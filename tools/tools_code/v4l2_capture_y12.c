...
#define IMAGE_SIZE (IMAGE_WIDTH * IMAGE_HEIGHT) +(IMAGE_WIDTH*IMAGE_HEIGHT)/2    //for raw12p
//#define IMAGE_SIZE (IMAGE_WIDTH * IMAGE_HEIGHT) +(IMAGE_WIDTH*IMAGE_HEIGHT)/4  //for raw10p
...
int cam_init()
{
	...
	//format.fmt.pix.pixelformat = V4L2_PIX_FMT_SRGGB12P;//12bit raw 
	format.fmt.pix.pixelformat = V4L2_PIX_FMT_Y12;//12bit gray
